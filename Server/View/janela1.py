...
class Ui_FileUpload(object):
    ...
    def retranslateUi(self, FileUpload):
        FileUpload.setWindowTitle(_translate("FileUpload Server", "File UpLoad Server", None))
        self.StartButton.setText(_translate("FileUpload Server", "Conectar", None))
        self.lineEdit.setText(_translate("FileUpload Server", "127.0.0.1", None))
        self.lineEdit_2.setText(_translate("FileUpload Server", "5000", None))
        self.label.setText(_translate("FileUpload Server", "IP", None))
        self.label_2.setText(_translate("FileUpload Server", "PORTA", None))
        self.label_3.setText(_translate("FileUpload Server", "Digite o IP e a Porta Servidor", None))
